...
-- LINKS
INSERT INTO links (id, user_id, original_url, short_code, title, description, is_anonymous, like_count, comment_count, view_count, created_at)
VALUES
  ('aaaaaaaa-0001-0001-0001-000000000001',
   ...
   false, 218, 24, 1204, NOW() - INTERVAL '3 hours'),
  ...
  ('aaaaaaaa-0002-0002-0002-000000000002',
   ...
   false, 184, 31, 944, NOW() - INTERVAL '5 hours'),
  ...
  ('aaaaaaaa-0003-0003-0003-000000000003',
   ...
   false, 312, 87, 3200, NOW() - INTERVAL '8 hours'),
  ...
  ('aaaaaaaa-0004-0004-0004-000000000004',
   ...
   true, 276, 42, 2100, NOW() - INTERVAL '12 hours'),
  ...
  ('aaaaaaaa-0005-0005-0005-000000000005',
   ...
   false, 94, 15, 720, NOW() - INTERVAL '1 day'),
  ...
  ('aaaaaaaa-0006-0006-0006-000000000006',
   ...
   false, 410, 38, 2800, NOW() - INTERVAL '6 hours'),
  ...
  ('aaaaaaaa-0007-0007-0007-000000000007',
   ...
   false, 388, 62, 4100, NOW() - INTERVAL '7 hours'),
  ...
  ('aaaaaaaa-0008-0008-0008-000000000008',
   ...
   false, 302, 29, 1900, NOW() - INTERVAL '9 hours'),
  ...
  ('aaaaaaaa-0009-0009-0009-000000000009',
   ...
   false, 248, 33, 1650, NOW() - INTERVAL '10 hours'),
  ...
  ('aaaaaaaa-0010-0010-0010-000000000010',
   ...
   false, 214, 27, 1420, NOW() - INTERVAL '11 hours'),
  ...
  ('aaaaaaaa-0011-0011-0011-000000000011',
   ...
   false, 156, 18, 890, NOW() - INTERVAL '2 days'),
  ...
  ('aaaaaaaa-0012-0012-0012-000000000012',
   ...
   false, 198, 22, 1350, NOW() - INTERVAL '18 hours'),
  ...
  ('aaaaaaaa-0013-0013-0013-000000000013',
   ...
   false, 143, 14, 760, NOW() - INTERVAL '3 days'),
  ...
  ('aaaaaaaa-0014-0014-0014-000000000014',
   ...
   false, 334, 71, 4800, NOW() - INTERVAL '4 hours'),
  ...
  ('aaaaaaaa-0015-0015-0015-000000000015',
   ...
   false, 167, 21, 1100, NOW() - INTERVAL '1 day 4 hours'),
  ...
  ('aaaaaaaa-0016-0016-0016-000000000016',
   ...
   false, 121, 16, 680, NOW() - INTERVAL '2 days 6 hours'),
  ...
  ('aaaaaaaa-0017-0017-0017-000000000017',
   ...
   false, 289, 44, 2200, NOW() - INTERVAL '5 hours'),
  ...
  ('aaaaaaaa-0018-0018-0018-000000000018',
   ...
   false, 201, 35, 1800, NOW() - INTERVAL '15 hours'),
  ...
  ('aaaaaaaa-0019-0019-0019-000000000019',
   ...
   false, 445, 93, 5600, NOW() - INTERVAL '2 hours'),
  ...
  ('aaaaaaaa-0020-0020-0020-000000000020',
   ...
   false, 378, 58, 3900, NOW() - INTERVAL '3 days');
