                ...
                links.map((link: any) => (
                  <div key={link.id} className="link-card">
                    ...
                    <div className="card-body">
                      ...
                      <Link href={`/link/${link.id}`} className="card-title" style={{ fontSize: '13px', fontWeight: '500', color: 'var(--text)', marginBottom: '5px', lineHeight: '1.4', letterSpacing: '-0.1px', display: 'block' }}>
                        {link.title}
                      </Link>
                      ...
                      <div className="card-footer">
                        <Link href={`/link/${link.id}`} className="card-stat">
