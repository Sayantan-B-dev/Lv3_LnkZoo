    ...
    <>
      ...
      <div id="content" className="legal-page fade-in">
        ...
        <section>
          ...
          <p>Glinqx uses essential cookies for authentication and security — these are necessary for the platform to function. We also use preference cookies to remember your theme and layout settings.</p>
        </section>
        ...
        <section>
          ...
          <p>You can control cookies through your browser settings. Disabling certain cookies may affect the functionality of Glinqx, particularly authentication and theme preferences.</p>
        </section>
