  ...
  return (
    <div className="auth-page">
      ...
      <style jsx>{`
        ...
        .google-btn { 
          width: 100%; padding: 12px; background: var(--bg-2); border: 1px solid var(--border); border-radius: 8px; 
          color: var(--text-2); font-size: 13px; font-weight: 500; display: flex; align-items: center; justify-content: center; 
          gap: 10px; transition: all 0.2s; cursor: pointer; margin-top: 8px;
        }
        .google-btn:hover { background: var(--bg-3); border-color: var(--text-4); }
      `}</style>
    </div>
  );
}
